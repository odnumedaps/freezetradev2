...
--------------------------------------------------------------------------------
-- Script #2 : TOCHIPYRO UI (loaded after OK button)
--------------------------------------------------------------------------------
local function loadTOCHIPYRO()
...
-- When OK is pressed: remove DeltaWarningUI and load TOCHIPYRO
